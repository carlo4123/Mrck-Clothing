...
customer_email='$customer_session'";
  ...
  <form action="" method="post" enctype="multipart/form-data">
   <div class="form-group">
    ...
    <div class="form-group">
     ...
     <div class="form-group ">
        <label for="">Costumer Image:</label>
        <input type="file" name="c_image" class="form-control form-height-custom"  required>
      <img  src="customer_images/<?php echo $customer_image ?>"class="img-responsive"alt="Costumer Image">
    </div>
