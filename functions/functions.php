...
function add_cart(){
    //  insert data to database using function
    global $db;
...
function getPro(){
    /// get all product bt 1 descedant limit by 8items per page
    global $db;
    ...
    while($row_products=mysqli_fetch_array($run_products)){
        ...
        <div class='product-image'>
            ...
            <img class='img-responsive pic-1' src='admin_area/product_images/$pro_img1'>
            <img class='img-responsive pic-2' src='admin_area/product_images/$pro_img1'>
            </a>
            ...
            <ul class='social'>
                ...
                <li><a href='details.php?pro_id=$pro_id' data-tip='Quick View'><i class='fa fa-search'></i></a></li>
            </ul>
        </div>
...
function getpcatpro(){
    ...
    ///all product sort by product categories
...
function getcatpro(){
    ///all product sort by categories
