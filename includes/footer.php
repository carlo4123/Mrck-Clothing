        ...
        <div class="row"><!-- row Begin -->
                    ...
                    <li>
                       <?php
                               ...
                               if(!isset($_SESSION['customer_email'])){
                                  ...
                                  echo"  <a href='customer/my_account.php?edit_account'>Edit Accout</a> "; 
            ...
            <div class="col-sm-6 col-md-3"><!-- col-sm-6 col-md-3 Begin -->
                ...
                <p><!-- p Start -->
                    ...
                    <strong>MrCK clothing inc.</strong>
                    <br/>Quezon City
                    <br/>Cubao
                    <br/>0995-789-4226
                    <br/>cominguez4123@gmail.com
                    <br/><strong>MrCK</strong>
...
<div id="copyright"><!-- #copyright Begin -->
    <div class="container"><!-- container Begin -->
        <div class="col-md-6"><!-- col-md-6 Begin -->
            ...
            <p class="pull-left">&copy; 2020 MRCK clothing Store All Rights Reserve</p>
            
        </div><!-- col-md-6 Finish -->
        <div class="col-md-6"><!-- col-md-6 Begin -->
            
            <p class="pull-right">Theme by: <a href="#">MrCK</a></p>
